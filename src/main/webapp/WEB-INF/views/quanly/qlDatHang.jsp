						...
						<h5>Welcome HUYEN_KUTE , Love to see you back.</h5>
							...
							<form:form action="quanly/qlDatHang.htm"
								...
								<div class="form-group">
									...
									<form:input path="maDh" class="form-control" id="inputSuccess" readonly="true"/>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input name="ngayDH" readonly="true" class="form-control" id="inputSuccess" value = "${donDatHangDangXem.ngay}"/>
								</div>
								<div class="form-group">
									<label>Địa Chỉ Giao Hàng</label> <form:input path="diaChi"
										class="form-control" id="inputSuccess"  readonly="true"/>
								</div>
								<div class="form-group">
									<label>Mã Giảm Giá </label> 
									<form:input path="maGiamGia" class="form-control"
										id="inputSuccess" type="text" readonly="true"/>
								</div>
