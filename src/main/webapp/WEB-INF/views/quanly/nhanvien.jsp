...
<body>
						...
						<div class="col-md-5"
							...
							<form:form action="quanly/nhanvien.htm"
								...
								<c:if test="${btnStatus == 'btnUpdate'}">
									<div class="form-group">
										...
										<form:input path="cmnd" class="form-control"
											id="disabledInput cmnd" type="text" readonly="true"
											 />
									</div>
								</c:if>
								<div class="input-row">
								...
								<div style="float: right;">
									...
									<button type="submit" class="btn btn-primary" name = "btnKhoaTaiKhoan">Khóa Tài Khoản</button>
								</div>
							</form:form>
						</div>
	...
	<script>
		...
		function checkValidate() {
			...
			var cmndValue ="";
			cmndValue = cmnd.value;
			var tenValue ="";
			tenValue= usernameEle.value;
			alert(tenValue);
			var phoneValue ="";
			...
			if (!isPhone(cmndValue)) {
				setError(cmnd, 'CMND phải đúng định dạng');
				isCheck = false;
