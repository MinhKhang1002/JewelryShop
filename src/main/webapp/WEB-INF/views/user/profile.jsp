          ...
          <div class="text-center">
           <label><h4 class="text-success">Thông tin cá nhân</h4></label>
            ...
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="editProfile.htm" method="post" id="registrationForm"  onsubmit='return checkValidate()'>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="last_name"><h4>Họ tên</h4></label>
                              <input type="text" class="form-control" name="hoTen" id="username" placeholder="Họ và tên" value="${Customer.hoTen }" >
                         ...
                         <div class="form-group">
                          <div class="col-xs-6">
                             <label for="mobile"><h4>Tên đăng nhập</h4></label>
                              <input type="text" class="form-control" name="tenDN"  placeholder="Tên đăng nhập" value="${acc.tenDangNhap }" readonly="true">
                          </div>
                      </div>
                        ...
                        <div class="form-group">
                          <div class="col-xs-6">
                             <label for="mobile"><h4>Mât khẩu</h4></label>
                              <input type="password" class="form-control" name="password"  placeholder="Mật khẩu" value="${acc.matKhau }">
                          </div>
                      </div> 
